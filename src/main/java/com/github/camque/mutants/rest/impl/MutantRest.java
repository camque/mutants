...
import com.github.camque.mutants.rest.IMutantRestController;
import com.github.camque.mutants.services.IMutantService;

@RestController
public class MutantRestController implements IMutantRestController {

	private static final Logger LOG = LogManager.getLogger(MutantRestController.class);
